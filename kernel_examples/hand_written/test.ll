...
entry:
  ...
  %control_variable = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 0, ptr %retval, align 4
  store i32 0, ptr %control_variable, align 4
...
for.body:                                         ; preds = %for.cond
  ...
  %2 = load i32, ptr %control_variable, align 4
  %add = add nsw i32 %2, %1
  store i32 %add, ptr %control_variable, align 4
  br label %for.inc
...
for.end:                                          ; preds = %for.cond
  %4 = load i32, ptr %control_variable, align 4
